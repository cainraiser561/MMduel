class MastermindDuel {
    ...
    handleGameMessage(message) {
        ...
        switch (message.messageType) {
            case 'code-set':
                ...
                console.log('Code set message received:', message.data);
                ...
                console.log('Codes set - P1:', this.player1Code, 'P2:', this.player2Code);
                
                // Check if both codes are set
                if (this.player1Code.length > 0 && this.player2Code.length > 0) {
                    console.log('Both codes set, starting gameplay');
                    this.startGameplay();
                } else {
                    console.log('Waiting for other player to set code');
                }
                break;
    ...
    confirmCode() {
        if (this.multiplayerMode === 'local') {
            ...
            // Notify other player via Netlify client
            this.sendGameMessage('code-set', {
